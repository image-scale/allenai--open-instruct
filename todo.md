...
- [x] Task 2: Implement data container classes for tokenized data, generation results, request info, and collated batch data with device transfer capabilities (data_types + tests)
